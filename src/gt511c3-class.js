...
class GT511C3 {
  constructor(port, config) {
    ...
    this.DEBUG = false,
    this.BAUDRATE = 9600,
    this.ACTUAL_BAUDRATE,

    this.DATA_PACKET_LENGTH,
    this.BUFFERSIZE = 100000; //serialport buffer size 100kB

    //GT-511C3 device ID
    this.DEVICE_ID = 0x0001;
    //start codes
    this.COMMAND_START_CODE_1 = 0x55,
    this.COMMAND_START_CODE_2 = 0xAA,
    this.RESPONSE_START_CODE_1 = 0x55,
    this.RESPONSE_START_CODE_2 = 0xAA,
    this.DATA_START_CODE_1 = 0x5A,
    this.DATA_START_CODE_2 = 0xA5;

    //timeout settings (ms)
    this.SEND_COMMAND_TIMEOUT = 1000,
    this.SEND_DATA_TIMEOUT = 1000,
    this.GET_DATA_TIMEOUT = 5000,
    this.GET_IMAGE_TIMEOUT = 10000,
    this.INIT_TIMEOUT = 5000;

    //GT-511C3 command list
    this.OPEN = 0x01,
    this.CLOSE = 0x02,
    this.USB_INTERNAL_CHECK = 0x03,
    this.CHANGE_BAUDRATE = 0x04,
    this.SET_IAP_MODE = 0x05,
    this.CMOS_LED = 0x12,
    this.GET_ENROLL_COUNT = 0x20,
    this.CHECK_ENROLLED = 0x21,
    this.ENROLL_START = 0x22,
    this.ENROLL_1 = 0x23,
    this.ENROLL_2 = 0x24,
    this.ENROLL_3 = 0x25,
    this.IS_PRESS_FINGER = 0x26,
    this.DELETE_ID = 0x40,
    this.DELETE_ALL = 0x41,
    this.VERIFY = 0x50,
    this.IDENTIFY = 0x51,
    this.VERIFY_TEMPLATE = 0x52,
    this.IDENTIFY_TEMPLATE = 0x53,
    this.CAPTURE_FINGER = 0x60,
    this.MAKE_TEMPLATE = 0x61,
    this.GET_IMAGE = 0x62,
    this.GET_RAW_IMAGE = 0x63,
    this.GET_TEMPLATE = 0x70,
    this.SET_TEMPLATE = 0x71,
    this.GET_DATABASE_START = 0x72,
    this.GET_DATABASE_END = 0x73,
    this.UPGRADE_FIRMWARE = 0x80,
    this.UPGRADE_ISO_CD_IMAGE = 0x81,
    this.ACK = 0x0030,
    this.NACK = 0x0031;

    //GT-511C3 paramaters
    this.NO_EXTRA_INFO = 0x00, //command OPEN
    this.EXTRA_INFO = 0x01,
    this.LED_OFF = 0x00, //command CMOS_LED
    this.LED_ON = 0x01,
    this.NOT_BEST_IMAGE = 0x00, //command CAPTURE_FINGER
    this.BEST_IMAGE = 0x01;

    //GT-511C3 error codes
    this.NACK_TIMEOUT = 0x1001
    this.NACK_INVALID_BAUDRATE = 0x1002,
    this.NACK_INVALID_POS = 0x1003,
    this.NACK_IS_NOT_USED = 0x1004,
    this.NACK_IS_ALREADY_USED = 0x1005,
    this.NACK_COMM_ERR = 0x1006,
    this.NACK_VERIFY_FAILED = 0x1007,
    this.NACK_IDENTIFY_FAILED = 0x1008,
    this.NACK_DB_IS_FULL = 0x1009,
    this.NACK_DB_IS_EMPTY = 0x100A,
    this.NACK_TURN_ERR = 0x100B,
    this.NACK_BAD_FINGER = 0x100C,
    this.NACK_ENROLL_FAILED = 0x100D,
    this.NACK_IS_NOT_SUPPORTED = 0x100E,
    this.NACK_DEV_ERR = 0x100F,
    this.NACK_CAPTURE_CANCELED = 0x1010,
    this.NACK_INVALID_PARAM = 0x1011,
    this.NACK_FINGER_IS_NOT_PRESSED = 0x1012;
  ...
  GT511C3.prototype.changeBaudRate = function(baudrate) {
    ...
    return (new Promise(function(resolve, reject) {
      ...
      if (this.ACTUAL_BAUDRATE == baudrate)
        reject('change baudrate error: baudrate already set to ' + this.ACTUAL_BAUDRATE);
